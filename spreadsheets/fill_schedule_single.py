...
fp = open(WORKSPACE_PREFIX + "myfile5_single.txt", 'r', encoding="utf-8")
for l_no, line in enumerate(fp):
    if 'fotka' in line:
        fot_tab.append(line[6:])

ff = open(WORKSPACE_PREFIX + "fotki_single.txt",mode='w', encoding="utf-8")
for elem in fot_tab:
    ff.write(elem)
...
fot_tab3=[]
fot_tab4=[]
ff = open(WORKSPACE_PREFIX + "fotki_single.txt",mode='r', encoding="utf-8")
...
sort_file(WORKSPACE_PREFIX + "fotki_single.txt", WORKSPACE_PREFIX + "fotki2_single.txt")
ff.close()
...
f_fotki = open(WORKSPACE_PREFIX + "fotki_single.txt",mode='r', encoding="utf-8")
...
if int(sin)==0:
    ...
    while not i==l_art_spa:
        sheet.cell(row=5+i+licznik, column=5).value = Lines_spa[i]
        sheet.cell(row=5+i+licznik, column=3).value = Lines_spa[i+l_art_spa*1]
        sheet.cell(row=5+i+licznik, column=10).value = int(Lines_spa[i+l_art_spa*2])
        sheet.cell(row=5+i+licznik, column=6).value = Lines_spa[i+l_art_spa*3]
        if brak:
            sheet.cell(row=5+i+licznik, column=7).value = zdj[i]
        i = i + 1
...
if int(sin)==1:
    ...
    while not i==l_art_pow:
        sheet.cell(row=5+i+licznik, column=5).value = Lines_pow[i]
        sheet.cell(row=5+i+licznik, column=3).value = Lines_pow[i+l_art_pow*1]
        sheet.cell(row=5+i+licznik, column=10).value = int(Lines_pow[i+l_art_pow*2])
        sheet.cell(row=5+i+licznik, column=6).value = Lines_pow[i+l_art_pow*3]
        if brak:
            sheet.cell(row=5+i+licznik, column=7).value = zdj[i]
        i = i + 1
    sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
...
if int(sin)==2:
    ...
    while not i==l_art_nk:
        sheet.cell(row=5+i+licznik, column=5).value = Lines_nk[i]
        sheet.cell(row=5+i+licznik, column=3).value = Lines_nk[i+l_art_nk*1]
        sheet.cell(row=5+i+licznik, column=10).value = int(Lines_nk[i+l_art_nk*2])
        sheet.cell(row=5+i+licznik, column=6).value = Lines_nk[i+l_art_nk*3]
        if brak:
            sheet.cell(row=5+i+licznik, column=7).value = zdj[i]
        i = i + 1
    sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
...
if int(sin)==3:
    ...
    while not i==l_art_szb:
        sheet.cell(row=5+i+licznik, column=5).value = Lines_szb[i]
        sheet.cell(row=5+i+licznik, column=3).value = Lines_szb[i+l_art_szb*1]
        sheet.cell(row=5+i+licznik, column=10).value = int(Lines_szb[i+l_art_szb*2])
        sheet.cell(row=5+i+licznik, column=6).value = Lines_szb[i+l_art_szb*3]
        if brak:
            sheet.cell(row=5+i+licznik, column=7).value = zdj[i]
        i = i + 1
    sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
...
if int(sin)==4:
    ...
    while not i==l_art_kc:
        sheet.cell(row=5+i+licznik, column=5).value = Lines_kc[i]
        sheet.cell(row=5+i+licznik, column=3).value = Lines_kc[i+l_art_kc*1]
        sheet.cell(row=5+i+licznik, column=10).value = int(Lines_kc[i+l_art_kc*2])
        sheet.cell(row=5+i+licznik, column=6).value = Lines_kc[i+l_art_kc*3]
        if brak:
            sheet.cell(row=5+i+licznik, column=7).value = zdj[i]
        i = i + 1
    sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
...
if int(sin)==5:
    ...
    while not i==l_art_mr:
        sheet.cell(row=5+i+licznik, column=5).value = Lines_mr[i]
        sheet.cell(row=5+i+licznik, column=3).value = Lines_mr[i+l_art_mr*1]
        sheet.cell(row=5+i+licznik, column=10).value = int(Lines_mr[i+l_art_mr*2])
        sheet.cell(row=5+i+licznik, column=6).value = Lines_mr[i+l_art_mr*3]
        if brak:
            sheet.cell(row=5+i+licznik, column=7).value = zdj[i]
        i = i + 1
    sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
...
if int(sin)==6:
    ...
    while not i==l_art_sd:
        sheet.cell(row=5+i+licznik, column=5).value = Lines_sd[i]
        sheet.cell(row=5+i+licznik, column=3).value = Lines_sd[i+l_art_sd*1]
        sheet.cell(row=5+i+licznik, column=10).value = int(Lines_sd[i+l_art_sd*2])
        sheet.cell(row=5+i+licznik, column=6).value = Lines_sd[i+l_art_sd*3]
        if brak:
            sheet.cell(row=5+i+licznik, column=7).value = zdj[i]
        i = i + 1
    sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
...
if int(sin)==7:
    ...
    while not i==l_art_rol:
        sheet.cell(row=5+i+licznik, column=5).value = Lines_rol[i]
        sheet.cell(row=5+i+licznik, column=3).value = Lines_rol[i+l_art_rol*1]
        sheet.cell(row=5+i+licznik, column=10).value = int(Lines_rol[i+l_art_rol*2])
        sheet.cell(row=5+i+licznik, column=6).value = Lines_rol[i+l_art_rol*3]
        if brak:
            sheet.cell(row=5+i+licznik, column=7).value = zdj[i]
        i = i + 1
    sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
...
if int(sin)==8:
    ...
    while not i==l_art_pol:
        sheet.cell(row=5+i+licznik, column=5).value = Lines_pol[i]
        sheet.cell(row=5+i+licznik, column=3).value = Lines_pol[i+l_art_pol*1]
        sheet.cell(row=5+i+licznik, column=10).value = int(Lines_pol[i+l_art_pol*2])
        sheet.cell(row=5+i+licznik, column=6).value = Lines_pol[i+l_art_pol*3]
        if brak:
            sheet.cell(row=5+i+licznik, column=7).value = zdj[i]
        i = i + 1
    sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
