...
fp = open(WORKSPACE_PREFIX + "myfile.txt", 'r', encoding="utf-8")
...
fot_tab3=[]
fot_tab4=[]
ff = open(WORKSPACE_PREFIX + "fotki.txt",mode='r', encoding="utf-8")
...
sort_file(WORKSPACE_PREFIX + "fotki.txt", WORKSPACE_PREFIX + "fotki2.txt")
ff.close()
...
while not i==l_art_spa:
    sheet.cell(row=5+i, column=5).value = Lines_spa[i]
    sheet.cell(row=5+i, column=3).value = Lines_spa[i+l_art_spa*1]
    sheet.cell(row=5+i, column=10).value = int(Lines_spa[i+l_art_spa*2])
    sheet.cell(row=5+i, column=6).value = Lines_spa[i+l_art_spa*3]
    if brak:
        sheet.cell(row=5+i, column=7).value = zdj[i]
    i = i + 1
...
while not i==l_art_pow:
    sheet.cell(row=5+i, column=5).value = Lines_pow[i]
    sheet.cell(row=5+i, column=3).value = Lines_pow[i+l_art_pow*1]
    sheet.cell(row=5+i, column=10).value = int(Lines_pow[i+l_art_pow*2])
    sheet.cell(row=5+i, column=6).value = Lines_pow[i+l_art_pow*3]
    if brak:
        sheet.cell(row=5+i, column=7).value = zdj[i]
    i = i + 1
sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
...
while not i==l_art_nk:
    sheet.cell(row=5+i, column=5).value = Lines_nk[i]
    sheet.cell(row=5+i, column=3).value = Lines_nk[i+l_art_nk*1]
    sheet.cell(row=5+i, column=10).value = int(Lines_nk[i+l_art_nk*2])
    sheet.cell(row=5+i, column=6).value = Lines_nk[i+l_art_nk*3]
    if brak:
        sheet.cell(row=5+i, column=7).value = zdj[i]
    i = i + 1
sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
...
while not i==l_art_szb:
    sheet.cell(row=5+i, column=5).value = Lines_szb[i]
    sheet.cell(row=5+i, column=3).value = Lines_szb[i+l_art_szb*1]
    sheet.cell(row=5+i, column=10).value = int(Lines_szb[i+l_art_szb*2])
    sheet.cell(row=5+i, column=6).value = Lines_szb[i+l_art_szb*3]
    if brak:
        sheet.cell(row=5+i, column=7).value = zdj[i]
    i = i + 1
sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
...
while not i==l_art_mr:
    sheet.cell(row=5+i, column=5).value = Lines_mr[i]
    sheet.cell(row=5+i, column=3).value = Lines_mr[i+l_art_mr*1]
    sheet.cell(row=5+i, column=10).value = int(Lines_mr[i+l_art_mr*2])
    sheet.cell(row=5+i, column=6).value = Lines_mr[i+l_art_mr*3]
    if brak:
        sheet.cell(row=5+i, column=7).value = zdj[i]
    i = i + 1
sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
...
while not i==l_art_sd:
    sheet.cell(row=5+i, column=5).value = Lines_sd[i]
    sheet.cell(row=5+i, column=3).value = Lines_sd[i+l_art_sd*1]
    sheet.cell(row=5+i, column=10).value = int(Lines_sd[i+l_art_sd*2])
    sheet.cell(row=5+i, column=6).value = Lines_sd[i+l_art_sd*3]
    if brak:
        sheet.cell(row=5+i, column=7).value = zdj[i]
    i = i + 1
sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
...
while not i==l_art_kc:
    sheet.cell(row=5+i, column=5).value = Lines_kc[i]
    sheet.cell(row=5+i, column=3).value = Lines_kc[i+l_art_kc*1]
    sheet.cell(row=5+i, column=10).value = int(Lines_kc[i+l_art_kc*2])
    sheet.cell(row=5+i, column=6).value = Lines_kc[i+l_art_kc*3]
    if brak:
        sheet.cell(row=5+i, column=7).value = str(zdj[i])
    i = i + 1
sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
source_file.save(fn)
#print("1x1 : ", str(sheet.cell(row=1, column=3).value))
...
while not i==l_art_rol:
    sheet.cell(row=5+i, column=5).value = Lines_rol[i]
    sheet.cell(row=5+i, column=3).value = Lines_rol[i+l_art_rol*1]
    sheet.cell(row=5+i, column=10).value = int(Lines_rol[i+l_art_rol*2])
    sheet.cell(row=5+i, column=6).value = Lines_rol[i+l_art_rol*3]
    if brak:
        sheet.cell(row=5+i, column=7).value = str(zdj[i])
    i = i + 1
sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
...
while not i==l_art_pol:
    sheet.cell(row=5+i, column=5).value = Lines_pol[i]
    sheet.cell(row=5+i, column=3).value = Lines_pol[i+l_art_pol*1]
    sheet.cell(row=5+i, column=10).value = int(Lines_pol[i+l_art_pol*2])
    sheet.cell(row=5+i, column=6).value = Lines_pol[i+l_art_pol*3]
    if brak:
        sheet.cell(row=5+i, column=7).value = str(zdj[i])
    i = i + 1
sheet.cell(row=1, column=3).value = nr_gazety+"/2026 wersja_A"
